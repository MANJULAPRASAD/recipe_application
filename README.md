...
Personalized Profiles: Interactive user profiles with custom culinary avatars and diet preferences.
...
Note: Make sure to place your google-services.json file inside the android/app/ directory before running the application for Firebase services to work.

🤝 Contributing

Contributions are always welcome! Feel free to open an issue or submit a pull request if you want to improve this application.
